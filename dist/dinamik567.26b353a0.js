...
(function (modules, entry, mainEntry, parcelRequireName, globalName) {
	...
	const cache = previousRequire.cache || {};
	...
	function newRequire(name, jumped) {
		...
		function localRequire(x) {
			const res = localRequire.resolve(x);
...
})(
	{
		kfT03: [
			function (require, module, exports) {
				...
				const HMR_HOST = null;
				const HMR_PORT = null;
				const HMR_SECURE = false;
				const HMR_ENV_HASH = "d6ea1d42532a7575";
				module.bundle.HMR_BUNDLE_ID = "7572ae3d26b353a0";
				("use strict");
...
*/ const OVERLAY_ID = "__parcel__error__overlay__";
				...
				let assetsToDispose /*: Array<[ParcelRequire, string]> */;
				let assetsToAccept /*: Array<[ParcelRequire, string]> */;
				...
				if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== "undefined") {
					...
					const protocol =
						...
						(location.protocol == "https:" && !/localhost|127.0.0.1|0.0.0.0/.test(hostname))
							? "wss"
							: "ws";
					const ws = new WebSocket(`${protocol}://${hostname}${port ? `:${port}` : ""}/`);
					...
					ws.onmessage = async function (event /*: {data: string, ...} */) {
						...
						if (data.type === "update") {
							...
							const assets = data.assets.filter((asset) => asset.envHash === HMR_ENV_HASH);
							// Handle HMR Update
									...
									: _hmrDownload.catch((err) => {
											...
											if (
												...
												asset.url = extCtx.runtime.getURL(
													`/__parcel_hmr_proxy__?url=${encodeURIComponent(
...
// # sourceMappingURL=dinamik567.26b353a0.js.map
